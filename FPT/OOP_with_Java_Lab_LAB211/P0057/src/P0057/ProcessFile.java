...
public class ProcessFile {
	...
	private static File file = new File("D:\\FPT\\OOP_with_Java_Lab_LAB211\\P0057\\user.dat");
	...
	public boolean fileChecker() {
		if (file.exists()) {
			System.out.println("user.dat file existed");
			return true;
		} else {
			System.out.println("user.dat file not found!");
			return false;
		}
	}
